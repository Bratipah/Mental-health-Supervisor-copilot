    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Shamiri Supervisor Tier Copilot</h1>
          <p className="text-blue-200 mt-1 text-sm">Africa's Largest Youth Mental Health Provider  </p>
        </div>

        {/* Login Card */}
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <h2 className="text-xl font-bold text-gray-900 mb-1">Welcome back</h2>
          <p className="text-gray-500 text-sm mb-6">Sign in to your supervisor dashboard</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-700 hover:bg-blue-800 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            >
              {loading ? (
          ...
          <div className="mt-5 p-3 bg-blue-50 rounded-lg border border-blue-100">
            <p className="text-xs text-blue-700 font-semibold mb-1">Demo account (pre-seeded)</p>
            <p className="text-xs text-blue-600">supervisor@copilot.demo · demo123</p>
          </div>
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-white text-xs text-gray-400">New to Supervisor Copilot?</span>
            </div>
          </div>
